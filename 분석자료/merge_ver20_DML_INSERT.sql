...
(3001, 2001, 1003, TO_DATE('2024-07-01', 'YYYY-MM-DD'), 2, 0, TO_DATE('2025-08-01', 'YYYY-MM-DD'));

INSERT INTO SALES_ORDER (SALES_NO, CLIENT_NO, EMP_NO, SALES_DATE, OUT_STATUS, DEL_STATUS, IN_DATE) VALUES
(3002, 2002, 1003, TO_DATE('2024-07-03', 'YYYY-MM-DD'), 1, 0, TO_DATE('2025-08-03', 'YYYY-MM-DD'));

INSERT INTO SALES_ORDER (SALES_NO, CLIENT_NO, EMP_NO, SALES_DATE, OUT_STATUS, DEL_STATUS, IN_DATE) VALUES
(3003, 2003, 1003, TO_DATE('2024-07-05', 'YYYY-MM-DD'), 1, 0, TO_DATE('2025-07-05', 'YYYY-MM-DD'));

INSERT INTO SALES_ORDER (SALES_NO, CLIENT_NO, EMP_NO, SALES_DATE, OUT_STATUS, DEL_STATUS, IN_DATE) VALUES
(3004, 2004, 1003, TO_DATE('2024-07-07', 'YYYY-MM-DD'), 1, 0, TO_DATE('2025-07-07', 'YYYY-MM-DD'));

INSERT INTO SALES_ORDER (SALES_NO, CLIENT_NO, EMP_NO, SALES_DATE, OUT_STATUS, DEL_STATUS, IN_DATE) VALUES
(3005, 2005, 1003, TO_DATE('2024-07-09', 'YYYY-MM-DD'), 1, 0, TO_DATE('2025-07-09', 'YYYY-MM-DD'));

INSERT INTO SALES_ORDER (SALES_NO, CLIENT_NO, EMP_NO, SALES_DATE, OUT_STATUS, DEL_STATUS, IN_DATE) VALUES
(3006, 2006, 1003, TO_DATE('2024-07-10', 'YYYY-MM-DD'), 0, 0, TO_DATE('2025-07-10', 'YYYY-MM-DD'));

INSERT INTO SALES_ORDER (SALES_NO, CLIENT_NO, EMP_NO, SALES_DATE, OUT_STATUS, DEL_STATUS, IN_DATE) VALUES
(3007, 2007, 1003, TO_DATE('2024-07-11', 'YYYY-MM-DD'), 0, 0, TO_DATE('2025-07-11', 'YYYY-MM-DD'));

INSERT INTO SALES_ORDER (SALES_NO, CLIENT_NO, EMP_NO, SALES_DATE, OUT_STATUS, DEL_STATUS, IN_DATE) VALUES
(3008, 2008, 1003, TO_DATE('2024-07-12', 'YYYY-MM-DD'), 0, 0, TO_DATE('2025-07-12', 'YYYY-MM-DD'));

INSERT INTO SALES_ORDER (SALES_NO, CLIENT_NO, EMP_NO, SALES_DATE, OUT_STATUS, DEL_STATUS, IN_DATE) VALUES
(3009, 2009, 1003, TO_DATE('2024-07-13', 'YYYY-MM-DD'), 0, 0, TO_DATE('2025-07-13', 'YYYY-MM-DD'));
