...
function applyStyles(instance) {
	...
	// 월 선택 콤보박스
	const monthSelectElement = cal.querySelector('.flatpickr-monthDropdown-months');
	if (monthSelectElement) {	
		monthSelectElement.style.fontSize = "20px";
    	monthSelectElement.style.fontWeight = "bold";
	}
	// 년 선택 스핀박스
	const yearSpinElement = cal.querySelector('.cur-year');
	if (yearSpinElement) {
		yearSpinElement.style.paddingRight = "10px";
		yearSpinElement.style.fontSize = "20px";
		yearSpinElement.style.fontWeight = "bold";
	}
