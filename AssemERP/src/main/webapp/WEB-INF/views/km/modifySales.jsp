...
<script>
    ...
    // 팝업에서 호출되는 콜백 (product_version 포함)
          ...
          tr.innerHTML =
            '<td>' +
              '<div class="input-group input-group-sm">' +
                ...
                '<input type="hidden" class="productVersionInput" name="sales_Item['+idx+'].product_Version" required/>' + /* ✅ 버전 hidden 추가 */ 
				...
				<div class="container-fluid px-4">
					<div class="card shadow-sm">
						...
						<div class="card-body p-4">
							<form id="salesForm"
								action="${pageContext.request.contextPath}/sales/modify"
								method="post">
								<!-- 키/상태 -->
									...
									<div class="row g-3">
										...
										<div class="col-md-4">
											<label class="form-label">담당자 이름</label> <input type="hidden"
												...
												value="${sales_OrderDto.empDTO.empNo}" /> <input
												...
												<tbody id="items-tbody">
													<c:choose>
														<c:when test="${not empty sales_OrderDto.sales_Item}">
															<c:forEach var="item"
																items="${sales_OrderDto.sales_Item}" varStatus="st">
																	...
																	<td>
																		<div class="input-group input-group-sm">
																			...
																			<input type="hidden" class="productVersionInput"
																				...
																				value="${item.product_Version}" /> <input
																				type="text"
												...
												<tfoot>
													<tr class="total-row">
														...
														<td class="numeric"><span id="sum-req"> <fmt:formatNumber
																	value="${sales_OrderDto.totCnt}" type="number"
																	groupingUsed="true" />
														</span></td>
														<td></td>
