					...
					<form method="post" action="/client/insert">
						...
						<div class="mb-3">
							<label for="clientName" class="form-label">거래처명</label> <input
								type="text" class="form-control form-control-sm" id="clientName"
						...
						<div class="text-end mt-4 pb-1 d-flex justify-content-end gap-2">
							...
							<!-- 등록 버튼 -->
							<button type="submit" class="btn btn-outline-primary btn-sm px-4">등록</button>
							
							 <a href="/business/clientStartList" class="btn btn-outline-danger btn-sm px-4">취소</a>
							
							
							<!-- 초기화 버튼 -->
							<button type="reset" class="btn btn-outline-secondary btn-sm px-4">초기화</button>
