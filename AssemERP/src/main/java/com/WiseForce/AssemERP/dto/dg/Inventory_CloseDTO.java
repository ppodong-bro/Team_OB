...
public class Inventory_CloseDTO {
	...
	// 조회
	private String yearmonth_start_text;// 년월 조회 시작
	private String yearmonth_end_text;// 년월 끝
	private LocalDate startDate; // 마감 조회 시작일
	private LocalDate endDate; // 마감 조회 종료일
//	private int close_status_select; // 마감 상태
	// 담당자
	
	// 조회 예시
	private String sample_yearmonth_start_text; // 년월 조회 시작 예시
	private String sample_yearmonth_end_text; // 년월 조회 끝 예시
