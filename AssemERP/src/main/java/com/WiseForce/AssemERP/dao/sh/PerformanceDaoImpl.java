...
public class PerformanceDaoImpl implements PerformanceDao {
	...
	public List<BigDecimal> getPurchaseData() {
		...
		try {
			perChaseData = session.selectList("com.WiseForce.AssemERP.sh.PerformanceMapper.shYearsPurchasePerformance",
					year);
	...
	public List<ClientPerformanceDTO> getSalesClientPerform() {
		...
		try {
			clientPerformanceDTOs = session
					.selectList("com.WiseForce.AssemERP.sh.PerformanceMapper.shSalesClientPerform");
			System.out.println(
					"PerformenceDaoImpl getSalesClientPerform clientPerformanceDTOs =>" + clientPerformanceDTOs);
		} catch (Exception e) {
	...
	public List<ClientPerformanceDTO> getPurchaseClientPerform() {
		...
		try {
			clientPerformanceDTOs = session
					.selectList("com.WiseForce.AssemERP.sh.PerformanceMapper.shPurchaseClientPerform");
			System.out.println(
					"PerformenceDaoImpl getPurchaseClientPerform clientPerformanceDTOs =>" + clientPerformanceDTOs);
		} catch (Exception e) {
	...
	public List<YearsPerformDTO> getInitYearsperform(int product_no) {
		...
		try {
			result = session.selectList("com.WiseForce.AssemERP.sh.PerformanceMapper.shProductPerform", product_no);
			System.out.println("PerformenceDaoImpl getInitYearsperform result => " + result);

		} catch (Exception e) {
			System.out.println("PerformenceDaoImpl getInitYearsperform Exception => " + e.getMessage());
		}
	...
	public int getMostProductOfYears() {
		...
		try {
			result = session.selectOne("com.WiseForce.AssemERP.sh.PerformanceMapper.shGetMostProductOfYears");
			System.out.println("PerformenceDaoImpl getInitYearsperform product_no => " + result);
	...
	public int getMostClientOfYears() {
		...
		try {
			result = session.selectOne("com.WiseForce.AssemERP.sh.PerformanceMapper.shGetMostClientOfYears");
			System.out.println("PerformenceDaoImpl getInitYearsperform product_no => " + result);
