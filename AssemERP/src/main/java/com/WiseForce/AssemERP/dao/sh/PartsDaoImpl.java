 ...
 * @Repository
 * 
 * @RequiredArgsConstructor public class PartsDaoImpl implements PartsDao {
 * 
 * private final SqlSession sqlSession;
 * 
 * @Override public List<PartsDTO> findPageList(PartsDTO partsDTO) {
 * 
 ...
 * 
 * try { partDTOList = sqlSession.selectList(
 * "com.WiseForce.AssemERP.PartsDTOMapper.shPartsListPage", partsDTO);
