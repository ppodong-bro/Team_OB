 ...
 * import jakarta.persistence.ManyToOne; import jakarta.persistence.MapsId;
 ...
 * @NoArgsConstructor
 * 
 * @SequenceGenerator( name = "product_seq_generator", sequenceName =
 * "product_seq", initialValue = 1, allocationSize = 1 ) public class Product {
 * 
 * @Id
 * 
 * @GeneratedValue( strategy = GenerationType.SEQUENCE, generator =
 * "product_seq_generator" ) private int product_no; private int product_status;
 * private String product_name; private String product_context; private String
