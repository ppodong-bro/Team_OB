 ...
 * @NoArgsConstructor
 * 
 * @AllArgsConstructor public class Sales_performance {
 * 
 * @Id private String yearmonth; private int cnt; private int total;
 * 
 * @ManyToOne(fetch = FetchType.LAZY)
 * 
 * @JoinColumn(name = "poduct_no") private Product product;
 * 
 * 
 * }
 */